...
(require "../utils/common.rkt" "../syntax/types.rkt" "../utils/pareto.rkt")
...
(struct report-info
  (date commit branch hostname seed flags points iterations note tests merged-cost-accuracy) #:prefab #:mutable)
