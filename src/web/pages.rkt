...
(define (get-interactive-js result ctx)
  (define start-prog (alt-expr (test-success-start-alt result)))
  (define end-prog (alt-expr (car (test-success-end-alts result))))
  (define start-fpcore (program->fpcore start-prog ctx))
  (define end-fpcore (program->fpcore end-prog ctx))
