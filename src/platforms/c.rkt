...
(define <array32> (make-array-representation #:name 'array32 #:elem <binary32> #:dims '(2)))
...
(define-operation (array2.f32 [x <binary32>] [y <binary32>]) <array32>
  #:spec (array x y)
  #:impl (lambda (a b) (vector a b))
  #:fpcore (! :precision binary32 (array x y))
  #:cost 0.25)

(define-operation (ref2.f32 [arr <array32>] [idx <binary32>]) <binary32>
  #:spec (ref arr idx)
...
(define-operation (array2.f64 [x <binary64>] [y <binary64>]) <array64>
  #:spec (array x y)
  #:impl (lambda (a b) (vector a b))
  #:fpcore (! :precision binary64 (array x y))
  #:cost 0.25)

(define-operation (ref2.f64 [arr <array64>] [idx <binary64>]) <binary64>
  #:spec (ref arr idx)
  #:impl (lambda (arr idx) (vector-ref arr (inexact->exact (round idx))))
