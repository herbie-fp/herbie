...
(define-operation (array.f32 [x <binary32>] [y <binary32>])
                  <array32>
                  #:spec (array x y)
...
(define-operation (array3.f32 [x <binary32>] [y <binary32>] [z <binary32>])
                  <array32r3>
                  #:spec (array x y z)
...
(define-operation (ref.f32 [arr <array32>] [idx <binary32>])
                  <binary32>
                  #:spec (ref arr idx)
...
(define-operation (ref.r3.f32 [arr <array32r3>] [idx <binary32>])
                  <binary32>
                  #:spec (ref arr idx)
                  #:impl (lambda (arr idx) (vector-ref arr (inexact->exact (round idx))))
                  #:fpcore (! :precision binary32 (ref arr idx))
...
(define-operation (array.f64 [x <binary64>] [y <binary64>])
                  <array64>
                  #:spec (array x y)
                  #:impl (lambda (a b) (vector a b))
...
(define-operation (array3.f64 [x <binary64>] [y <binary64>] [z <binary64>])
                  <array64r3>
                  #:spec (array x y z)
                  #:impl (lambda (a b c) (vector a b c))
...
(define-operation (array2.f64 [x <array64>] [y <array64>])
                  <array64r2>
                  #:spec (array x y)
                  #:impl (lambda (a b) (vector a b))
                  #:fpcore (array x y)
...
(define-operation (ref.f64 [arr <array64>] [idx <binary64>])
                  <binary64>
                  #:spec (ref arr idx)
                  #:impl (lambda (arr idx) (vector-ref arr (inexact->exact (round idx))))
...
(define-operation (ref.r3.f64 [arr <array64r3>] [idx <binary64>])
                  <binary64>
                  #:spec (ref arr idx)
                  #:impl (lambda (arr idx) (vector-ref arr (inexact->exact (round idx))))
                  #:fpcore (! :precision binary64 (ref arr idx))
...
(define-operation (ref.r2.f64 [arr <array64r2>] [idx <binary64>])
                  <array64>
                  #:spec (ref arr idx)
                  #:impl (lambda (arr idx) (vector-ref arr (inexact->exact (round idx))))
                  #:fpcore (! :precision binary64 (ref arr idx))
