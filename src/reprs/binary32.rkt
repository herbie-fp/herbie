...
(when fma.f32
  (register-accelerator-impl! 'fma 'fma.f32
...
(when erfc.f32
  (register-accelerator-impl! 'erfc 'erfc.f32
                              (list (get-representation 'binary32)) (get-representation 'binary32)
                              erfc.f32))
