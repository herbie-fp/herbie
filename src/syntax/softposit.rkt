...
(define (bf-posit8< x y) (bf< (big-posit8-v x) (big-posit8-v y)))
(define (bf-posit8<= x y) (bf<= (big-posit8-v x) (big-posit8-v y)))
(define (bf-posit8> x y) (bf> (big-posit8-v x) (big-posit8-v y)))
(define (bf-posit8>= x y) (bf>= (big-posit8-v x) (big-posit8-v y)))
(define (bf-posit8= x y) (bf= (big-posit8-v x) (big-posit8-v y)))
...
(define (bf-posit16< x y) (bf< (big-posit16-v x) (big-posit16-v y)))
(define (bf-posit16<= x y) (bf<= (big-posit16-v x) (big-posit16-v y)))
(define (bf-posit16> x y) (bf> (big-posit16-v x) (big-posit16-v y)))
(define (bf-posit16>= x y) (bf>= (big-posit16-v x) (big-posit16-v y)))
(define (bf-posit16= x y) (bf= (big-posit16-v x) (big-posit16-v y)))
...
(define (bf-posit32< x y) (bf< (big-posit32-v x) (big-posit32-v y)))
(define (bf-posit32<= x y) (bf<= (big-posit32-v x) (big-posit32-v y)))
(define (bf-posit32> x y) (bf> (big-posit32-v x) (big-posit32-v y)))
(define (bf-posit32>= x y) (bf>= (big-posit32-v x) (big-posit32-v y)))
(define (bf-posit32= x y) (bf= (big-posit32-v x) (big-posit32-v y)))
