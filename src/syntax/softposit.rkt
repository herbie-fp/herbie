...
;; TODO: Consider contacts to ensure v is a posit
(define (create-quire8 [v null]) (if (eq? v null)
  (get-ffi-obj "make_q8" "softposit" (_fun -> _quire8))
  (quire8-fdp-add (create-quire8) v (double->posit8 1.0))))
(define (create-quire16 [v null]) (if (eq? v null)
  (get-ffi-obj "make_q16" "softposit" (_fun -> _quire16))
  (quire16-fdp-add (create-quire16) v (double->posit16 1.0))))
(define (create-quire32 [v null]) (if (eq? v null)
  (get-ffi-obj "make_q32" "softposit" (_fun -> _quire32))
