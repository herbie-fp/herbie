...
(require
 "rules.rkt" "../syntax/sugar.rkt" "../syntax/syntax.rkt" "../syntax/types.rkt"
 "alt-table.rkt" "bsearch.rkt" "egg-herbie.rkt" "localize.rkt"
 "regimes.rkt" "simplify.rkt" "../utils/alternative.rkt" "../utils/common.rkt" "../utils/float.rkt"
 "../syntax/conversions.rkt" "explain.rkt" "patch.rkt" "../syntax/platform.rkt" "points.rkt"
 "preprocess.rkt" "programs.rkt" "../utils/timeline.rkt" "sampling.rkt" "soundiness.rkt")
