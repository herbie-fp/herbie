...
(require rackunit)
(require "../syntax/accelerator.rkt" "../utils/common.rkt" "../core/compiler.rkt"
         "../utils/float.rkt" "sampling.rkt" "../syntax/types.rkt" "../syntax/load-plugin.rkt"
         "rules.rkt" (submod "rules.rkt" internals)
         "../syntax/sugar.rkt" "egg-herbie.rkt")
