...
(define soundness-proofs
  '((pow-plus (implies (< b -1) (< b 0)))
    ...
    (acos-half-asin-rev (implies (< 1 (fabs x))
                                 (or (< 1 x) (< 1 (fabs (sqrt (/ (- 1 x) 2)))))))
    (acos-half-acos (implies (< 1 (fabs (sqrt (/ (+ 1 x) 2)))) (< 1 (fabs x)))
                    (implies (< x -1) (< 1 (fabs x))))
    (acos-half-acos-rev (implies (< 1 (fabs x))
                                 (or (< x -1) (< 1 (fabs (sqrt (/ (+ 1 x) 2)))))))
    (acos-1sub-asin (implies (< 1 (fabs (sqrt (/ x 2)))) (< 1 (fabs (- 1 x))))
                    (implies (< x 0) (< 1 (fabs (- 1 x)))))
    (acos-1sub-asin-rev (implies (< 1 (fabs (- 1 x)))
                                 (or (< x 0) (< 1 (fabs (sqrt (/ x 2)))))))
    (div-sub-halving (implies (== (- (* 1/2 c) (* 1/2 d)) 0) (== (- c d) 0)))
    (tan-pi-reduce (implies (== (cos (* (remainder x 1) (PI))) 0) (== (cos (* x (PI))) 0)))
    (tan-deg-reduce (implies (== (cos (* (/ (remainder x 180) 180) (PI))) 0)
                             (== (cos (* (/ x 180) (PI))) 0)))
    (log-tan-quarter-half (implies (== (sin x) 1) (== (cos (+ (/ (PI) 4) (/ x 2))) 0))
                          (implies (== (sin x) -1) (== (sin (+ (/ (PI) 4) (/ x 2))) 0)))))
