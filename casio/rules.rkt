...
(define-syntax (define-rule stx)
  (syntax-case stx ()
    [(_ name input output slocations)
...
(define-rule   *-commutative     (* a b)               (* b a)           ())
; Associativity
(define-rule   associate-+-lft   (+ a (+ b c))         (+ (+ a b) c)     ((cdr car)))
(define-rule   associate-+-rgt   (+ (+ a b) c)         (+ a (+ b c))     ((cdr cdr car)))
(define-rule   associate---lft   (+ a (- b c))         (- (+ a b) c)     ((cdr car)))
(define-rule   associate---rgt   (- (+ a b) c)         (+ a (- b c))     ((cdr cdr car)))
(define-rule   associate-*-lft   (* a (* b c))         (* (* a b) c)     ((cdr car)))
(define-rule   associate-*-rgt   (* (* a b) c)         (* a (* b c))     ((cdr cdr car)))
...
(define-rule   associate-/-rgt   (/ (* a b) c)         (* a (/ b c))     ((cdr cdr car)))
; Distributivity
(define-rule   distribute-lft-in     (* a (+ b c))         (+ (* a b) (* a c))     ((cdr car) (cdr cdr car)))
(define-rule   distribute-rgt-in     (* a (+ b c))         (+ (* b a) (* c a))     ((cdr car) (cdr cdr car)))
(define-rule   distribute-lft-out    (+ (* a b) (* a c))   (* a (+ b c))           ((cdr cdr car)))
(define-rule   distribute-rgt-out    (+ (* b a) (* c a))   (* a (+ b c))           ((cdr cdr car)))
; Identity
...
(define-rule   div-sub           (/ (- a b) c)         (- (/ a c) (/ b c))                  ((cdr car) (cdr cdr car)))
(define-rule   sub-div           (- (/ a c) (/ b c))   (/ (- a b) c)                        ((cdr car)))
(define-rule   frac-sub          (- (/ a b) (/ c d))   (/ (- (* a d) (* b c)) (* b d))      ((cdr car)))
; Square root  
...
(define-rule   square-prod       (square (* x y))      (* (square x) (square y))     ((cdr car) (cdr cdr car)))
(define-rule   square-unprod     (* (square x) (square y)) (square (* x y))          ((cdr car)))
(define-rule   square-div        (square (/ x y))      (/ (square x) (square y))     ((cdr car) (cdr cdr car)))
(define-rule   square-undiv      (/ (square x) (square y)) (square (/ x y))          ((cdr car)))
; Exponentials
...
; Multiplying by x / x
(define-rule   flip-+            (+ a b)               (/ (- (square a) (square b)) (- a b))   ((cdr car) (cdr cdr car)))
(define-rule   flip--            (- a b)               (/ (- (square a) (square b)) (+ a b))   ((cdr car) (cdr cdr car)))
