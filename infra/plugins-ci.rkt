...
(define softposit-platform
  (with-terminal-cost
   ([posit8 1] [posit16 1] [posit32 1] [quire8 1] [quire16 1] [quire32 1])
   ; posit operators
   (platform-union (platform-product [([real posit8] [bool bool]) (cost-map #:default-cost 1)]
                                     [([real posit16] [bool bool]) (cost-map #:default-cost 1)]
                                     [([real posit32] [bool bool]) (cost-map #:default-cost 1)]
                                     (operator-set [(real real) (neg sqrt)]
                                                   [(real real real) (+ - * /)]
                                                   [(real real bool) (== != > < >= <=)]))
                   ; quire operations
                   (platform #:default-cost 1
