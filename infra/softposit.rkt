...
(define-operation (if.p8 [c <bool>] [t <posit8>] [f <posit8>])
                  <posit8>
                  #:spec (if c t f)
                  #:impl if-impl
                  #:cost (if-cost 1))
(define-representation <posit16> #:cost 1)
(define-operation (if.p16 [c <bool>] [t <posit16>] [f <posit16>])
                  <posit16>
                  #:spec (if c t f)
                  #:impl if-impl
                  #:cost (if-cost 1))
(define-representation <posit32> #:cost 1)
(define-operation (if.p32 [c <bool>] [t <posit32>] [f <posit32>])
                  <posit32>
                  #:spec (if c t f)
                  #:impl if-impl
                  #:cost (if-cost 1))

(define-operations ([x <posit8>] [y <posit8>])
  <bool>
...
(define-operations ([x <posit8>])
  <posit8>
  #:fpcore (! :precision posit8 _)
...
(define-operations ([x <posit16>] [y <posit16>])
  <bool>
...
(define-operations ([x <posit16>])
  <posit16>
  #:fpcore (! :precision posit16 _)
...
(define-operations ([x <posit32>] [y <posit32>])
  <bool>
...
(define-operations ([x <posit32>])
  <posit32>
  #:fpcore (! :precision posit32 _)
...
(define-operations ([x <quire8>] [y <posit8>] [z <posit8>])
  <quire8>
  #:fpcore (! :precision quire8 _)
...
(define-operations ([x <quire16>] [y <posit16>] [z <posit16>])
  <quire16>
  #:fpcore (! :precision quire16 _)
...
(define-operations ([x <quire32>] [y <posit32>] [z <posit32>])
  <quire32>
  #:fpcore (! :precision quire32 _)
...
(define-operation (binary64->posit8 [x <binary64>])
                  <posit8>
                  #:spec x
                  #:impl double->posit8
                  #:fpcore (! :precision posit8 (cast x))
                  #:cost 1)
(define-operation (binary64->posit16 [x <binary64>])
                  <posit16>
                  #:spec x
                  #:impl double->posit16
                  #:fpcore (! :precision posit16 (cast x))
                  #:cost 1)
(define-operation (binary64->posit32 [x <binary64>])
                  <posit32>
                  #:spec x
                  #:impl double->posit32
                  #:fpcore (! :precision posit32 (cast x))
                  #:cost 1)
(define-operation (posit8->binary64 [x <posit8>])
                  <binary64>
                  #:spec x
                  #:impl posit8->double
                  #:fpcore (! :precision binary64 (cast x))
                  #:cost 1)
(define-operation (posit16->binary64 [x <posit16>])
                  <binary64>
                  #:spec x
                  #:impl posit16->double
                  #:fpcore (! :precision binary64 (cast x))
                  #:cost 1)
(define-operation (posit32->binary64 [x <posit32>])
                  <binary64>
                  #:spec x
                  #:impl posit32->double
                  #:fpcore (! :precision binary64 (cast x))
...
(define-operation (binary64->quire8 [x <binary64>])
                  <quire8>
                  #:spec x
                  #:impl double->quire8
                  #:fpcore (! :precision quire8 (cast x))
                  #:cost 1)
(define-operation (binary64->quire16 [x <binary64>])
                  <quire16>
                  #:spec x
                  #:impl double->quire16
                  #:fpcore (! :precision quire16 (cast x))
                  #:cost 1)
(define-operation (binary64->quire32 [x <binary64>])
                  <quire32>
                  #:spec x
                  #:impl double->quire32
                  #:fpcore (! :precision quire32 (cast x))
                  #:cost 1)
(define-operation (quire8->binary64 [x <quire8>])
                  <binary64>
                  #:spec x
                  #:impl quire8->double
                  #:fpcore (! :precision binary64 (cast x))
                  #:cost 1)
(define-operation (quire16->binary64 [x <quire16>])
                  <binary64>
                  #:spec x
                  #:impl quire16->double
                  #:fpcore (! :precision binary64 (cast x))
                  #:cost 1)
(define-operation (quire32->binary64 [x <quire32>])
                  <binary64>
                  #:spec x
                  #:impl quire32->double
                  #:fpcore (! :precision binary64 (cast x))
...
(define-operation (quire8->posit8 [x <quire8>])
                  <posit8>
                  #:spec x
                  #:impl quire8->posit8
                  #:fpcore (! :precision posit8 (cast x))
                  #:cost 1)
(define-operation (quire16->posit16 [x <quire16>])
                  <posit16>
                  #:spec x
                  #:impl quire16->posit16
                  #:fpcore (! :precision posit16 (cast x))
                  #:cost 1)
(define-operation (quire32->posit32 [x <quire32>])
                  <posit32>
                  #:spec x
                  #:impl quire32->posit32
                  #:fpcore (! :precision posit32 (cast x))
                  #:cost 1)
(define-operation (posit8->quire8 [x <posit8>])
                  <quire8>
                  #:spec x
                  #:impl posit8->quire8
                  #:fpcore (! :precision quire8 (cast x))
                  #:cost 1)
(define-operation (posit16->quire16 [x <posit16>])
                  <quire16>
                  #:spec x
                  #:impl posit16->quire16
                  #:fpcore (! :precision quire16 (cast x))
                  #:cost 1)
(define-operation (posit32->quire32 [x <posit32>])
                  <quire32>
                  #:spec x
                  #:impl posit32->quire32
                  #:fpcore (! :precision quire32 (cast x))
                  #:cost 1)
