...
tune_path = os.path.join(script_dir, 'tune.py')
improve_path = os.path.join(script_dir, 'improve.py')
compare_path = os.path.join(script_dir, 'compare.py')
baseline_path = os.path.join(script_dir, 'baseline.py')
merge_path = os.path.join(script_dir, 'merge.py')
