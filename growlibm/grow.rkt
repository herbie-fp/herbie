...
(define-operation (9-sqrtz0z1z0z1z0.f64 [z0 <binary64>] [z1 <binary64>]) <binary64> #:spec (+ (sqrt (* (- z0 z1) (+ z0 z1))) z0) #:impl (from-rival) #:fpcore (! :precision binary64 (9-sqrtz0z1z0z1z0 z0 z1)) #:cost 0.0)
(define-operation (9-sqrtz0z1z0z1z0.f32 [z0 <binary32>] [z1 <binary32>]) <binary32> #:spec (+ (sqrt (* (- z0 z1) (+ z0 z1))) z0) #:impl (from-rival) #:fpcore (! :precision binary32 (9-sqrtz0z1z0z1z0 z0 z1)) #:cost 0.0)
