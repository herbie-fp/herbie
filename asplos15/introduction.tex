...
software.  In our experiments, one such library imposed \todo{mpfr
  overhead} runtime overhead to achieve \todo{NNN} bits of accuracy
which required \todo{NNN} bits of precision on average. Even this
