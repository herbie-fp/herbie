...
software.  In our experiments, the overhead was \todo{mpfr overhead}
to get \todo{NNN} accuracy which required \todo{NNN} bits on
...
\todo{cite}, robust multi-precision floating point representations
designed for efficient hardware implementation \todo{cite}, and
numerous program transformations to reduce error \todo{cite}.
