...
\todo{cite}, arbitrary precision floating point libraries \todo{cite},
and numerous optimizations aimed at improving accuracy \todo{cite}.
...
well with precision.  \todo{back these points up with examples from
  evaluation}
...
implementation is able to \todo{impressive summary of evaluation}.
