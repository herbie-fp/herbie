...
\begin{abstract}
  ...
  Use of hardware-supported floating point arithmetic is ubiquitous
  across diverse academic disciplines from scientific computing to
  finance. Developers of these applications typically use floating
  point as an approximation to computation over real numbers. 
