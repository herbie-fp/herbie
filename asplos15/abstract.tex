...
\begin{abstract}
  ...
  variant for each regime.  We evaluated \casio on examples from a
  classic numerical methods textbook and found that it improved
  accuracy in 21 out of 28 tests by up to 27 bits while imposing an
  average performance overhead of 45\%.  We also present a series of
  case studies using a formulas found in the wild to show that \casio
