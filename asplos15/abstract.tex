...
\begin{abstract}
  ...
  applications typically use floating point to approximate computation
  over real numbers.  Unfortunately, this approximation introduces
  ...
  approach to estimating error and its causes, and is tailored to
