...
\begin{abstract}
  ...
  classic numerical methods textbook and \jdiff{demonstrate that it
    can effectively reduce rounding error}{find that it reduces
    average error by \todo{some quantitative measure}.}. We also
  present a series of case studies using a formulas found in the wild
  to show that \casio has broad applicability.
