...
\begin{abstract}
  ...
  benchmarks drawn from numerical methods textbooks and demonstrate
  that it can substantially reduce error. We also consider \casio's
  broader applicability by improving accuracy of expressions from a
