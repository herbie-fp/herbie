...
Figure~\ref{fig:eval-rect}. \todo{more discussion of actual data}. Of
...
\para{Overhead} We also measured performance overhead. \casio incurs
an average overhead of \todo{N}\%.  In \todo{N} of the 29 benchmarks,
