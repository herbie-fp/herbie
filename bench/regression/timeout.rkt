(FPCore (a b c) :name "Random Jason Timeout Test 001" (+ c (asin (cosh c))))
(FPCore
 (a b c d)
 :name
 "Random Jason Timeout Test 002"
 (mod (sinh c) (- c (sqr -2.9807307601812193e+165))))
(FPCore
 (a b c)
 :name
...
(FPCore
 (a)
 :name
 "Random Jason Timeout Test 005"
 (cotan (expm1 (log1p (+ (asin 5.5642831668124635e+247) (sqrt a))))))
(FPCore
 (a)
 :name
...
(FPCore
 ...
 :name
 "Random Jason Timeout Test 007"
 (atan (log1p (+ (log -1.8207626529605104e-301) c))))
(FPCore
 ((a default) (b default) (c default))
 :name
 "Random Jason Timeout Test 008"
 (*
  (* (atan (atan 3.882919441585229e-190)) 4.568031610793939e-123)
  (mod (sqrt -1.0580015533610528e+239) b)))
(FPCore
 (a b c)
 :name
 "Random Jason Timeout Test 009"
 (abs (mod c (asin (- 2.821952756469356e+184 b)))))
(FPCore (a) :name "Random Jason Timeout Test 010" (/ a (- (acos a))))
(FPCore
 (a)
 :name
...
(FPCore
 ...
 (sqrt
  (*
   ...
   (- (/ (+ (+ a b) c) 2) c))))
(FPCore
 ((n default) (U default) (t default) (l default) (Om default) (U* default))
 :name
...
(FPCore
 ((x default) (y default) (z default) (t default) (a default))
 :name
